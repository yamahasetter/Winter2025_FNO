...
load_model_path = '../../Models/10/'
data_path = '../../data/run4/'
path_outputs = '/media/volume/alyns/Research/Models/10/Analysis/'
...
# load the parameters for the model
net.load_state_dict(torch.load(load_model_path + 'FNO2D_EulerStep_Spectral_Loss_batch_sizes_20_lr_0.002_modes_10_wavenum_8_lead_5.pt'))
