...
def load_training_data_ball(data_dir, trainN, lead, var=0.001, selection=None, exclude=None, lim=199):
    """
        arguments:
            `trainN`, `lead`, `data_dir`
...
# data_path = '../../data/run4/'
# model_path = f'../../Models/singletons/{run_number}/'
...
# model_name = f'FNO2D_Eulerstep_MSE_Loss_Training_Ball_modes_{modes}_wavenum_{wavenum_init}_lead_{lead}.pt'
...
#     # running_loss = 0.0
#     input_batch, label_batch = load_training_data_ball(data_path, trainN, lead, exclude=excluding)
